...
class HostPodiumPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: darkBackground,
        title: const Text('Host - Podio', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
        leading: IconButton(
        ...
        return Column(
            children: [
                const Padding(
                    ...
                    child: Text('¡El juego ha terminado!', style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: Colors.amber)),
                ),
                Expanded(
                    child: ListView(
