...
class LibraryQuizEditorPage extends StatefulWidget {
  final int? index;
  final String? initialTitle;
  final List<String>? initialAnswers;
  final int? initialTime;
  const LibraryQuizEditorPage({Key? key, this.index, this.initialTitle, this.initialAnswers, this.initialTime}) : super(key: key);

  @override
  State<LibraryQuizEditorPage> createState() => _LibraryQuizEditorPageState();
}

class _LibraryQuizEditorPageState extends State<LibraryQuizEditorPage> {
  final TextEditingController questionController = TextEditingController();
  final List<TextEditingController> answerControllers = List.generate(4, (_) => TextEditingController());
  final List<TextEditingController> extraAnswerControllers = List.generate(2, (_) => TextEditingController());
