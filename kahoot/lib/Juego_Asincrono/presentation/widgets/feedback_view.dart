        ...
        child: Column(
          ...
          children: [
            ...
            ScaleTransition(
              ...
              // Eliminar el Container con decoración y dejar directo la imagen
              child: Image.asset(
                widget.wasCorrect
                    ? GameAssets.iconCorrect
                    : GameAssets.iconWrong,
                width:
                    120, // Aumenté un poco el tamaño para compensar la falta de fondo
                height: 120,
                fit: BoxFit.contain,
                errorBuilder: (context, error, stackTrace) {
                  ...
                  return Icon(
                    ...
                    size: 100,
                    // Colorear el icono ya que no hay fondo
